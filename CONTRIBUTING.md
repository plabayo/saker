...
1. [File an issue](https://github.com/plabayo/saker/issues/new).
...
3. Clone the repo: `git clone https://github.com/plabayo/saker`
4. Change into the checked out source: `cd news`
5. Fork the repo.
6. Set your fork as a remote: `git remote add fork git@github.com:GITHUB_USERNAME/saker.git`
...
See [the README](https://github.com/plabayo/saker#minimum-supported-rust-version) for the minimum supported Rust version (MSRV).
